          ...
          <div className="sticky top-[90px]">
            ...
            {product.attachment && (
              <a
                ...
                className="flex items-center gap-3 mb-8 p-4 rounded-xl bg-gray-50 border border-gray-100 hover:border-[#1E88FF]/30 hover:bg-[#1E88FF]/[0.03] transition-all duration-200 group"
              >
                <div className="w-10 h-10 rounded-lg bg-[#1E88FF]/10 flex items-center justify-center text-[#1E88FF] shrink-0">
