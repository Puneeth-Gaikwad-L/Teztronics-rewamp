...
const FIELDS = [
  { id: "org", label: "Your Name / Organisation", placeholder: "Your name or company name", required: true, type: "text" },
  ...
  { id: "quantity", label: "Quantity Needed", placeholder: "e.g. 10 pcs, bulk, sample", required: false, type: "text" },
];
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="sticky top-24 rounded-xl border border-gray-200 bg-gray-50 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {FIELDS.map((f) => (
                <div key={f.id}>
                  ...
                  <input
                    ...
                    required={f.required}
                    className="w-full bg-gray-100 border border-gray-200 rounded-md px-4 py-3 text-[14px] text-[#060912] placeholder-gray-400 focus:outline-none focus:border-[#1E88FF]/50 focus:bg-[#1E88FF]/[0.04] transition-all duration-200"
                  />
                </div>
              ))}
              ...
              <button
                type="submit"
                className="mt-2 w-full flex items-center justify-center gap-2.5 py-3.5 bg-[#1E88FF] hover:bg-[#3d9fff] text-white font-['Plus_Jakarta_Sans'] font-bold text-[13px] uppercase tracking-widest rounded-md transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(30,136,255,0.28)]"
              >
